...
setup-prod:
	...
	pip install PyNaCl --platform manylinux1_x86_64 --no-deps -d  prod-venv/lib/python3.9/site-packages
	pip install cffi --platform manylinux1_x86_64 --no-deps -d  prod-venv/lib/python3.9/site-packages
	pip install bcrypt --platform manylinux1_x86_64 --no-deps -d  prod-venv/lib/python3.9/site-packages
	pip install cryptography --platform manylinux2014_x86_64 --no-deps -d  prod-venv/lib/python3.9/site-packages
